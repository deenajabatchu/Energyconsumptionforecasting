...
fig = plt.figure(figsize = (15,10))
sns.boxplot(x=dataset["Month"], y=dataset["Consumption"], data= dataset)
...
fig = plt.figure(figsize = (15,10))
sns.boxplot(x=dataset1.index.year, y=dataset1.Consumption, data= dataset1)
...
y = newDataSet.values.reshape(-1,1) # Changed to use newDataSet directly and reshape
# print(y[0]) # This line was causing an error before, now y is a numpy array
y.shape
